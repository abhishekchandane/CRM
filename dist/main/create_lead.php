          ...
          <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
            <div class="card-body px-4 py-3">
              <div class="row align-items-center">
                <div class="col-9">
                  <h4 class="fw-semibold mb-8">Create Lead</h4>
                  <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item">
                        <a class="text-muted text-decoration-none" href="../main/index.html">Home</a>
                      </li>
                      <li class="breadcrumb-item" aria-current="page">Create Lead</li>
                    </ol>
                  </nav>
                </div>
                <div class="col-3">
                ...
                <div class="tab-content" id="pills-tabContent">
                  ...
                  <h4 class="card-title mb-3">        Details</h4>
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <div class="mb-4">
                            <label for="exampleInputfirstname2" class="form-label">Title</label>
                            <input type="text" class="form-control" id="exampleInputfirstname2" placeholder="Title">
                            </div>

                            <div class="mb-4">
                                <label class="form-label">Description</label>
                                <textarea class="form-control" name="" id="" cols="20" rows=1" placeholder=" Description"></textarea>
                            </div>

                            <div class="mb-4">
                            <label for="sourceSelect" class="form-label">Source</label>
                            <select class="form-select" id="sourceSelect" aria-label="Select Source">
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="mb-4">
                                ...
                                <select class="form-select" id="typeSelect" aria-label="Select Type">
                            ...
                            <select class="form-select" id="salesOwnerSelect" aria-label="Select salesOwner">
                    ...
                    <div class="row"> 
                      <div class="col-lg-6">
                        <div class="mb-4">
                          ...
                          <input type="text" class="form-control" id="name" placeholder="John Deo">
                        </div>
                      ...
                      <div class="col-lg-6"> 
                        ...
                        <div class="contact-number-repeater mb-3"> 
                        <div data-repeater-list="repeater-group">
                        <div data-repeater-item class="row mb-3">
                            <div class="col-md-10">
                    ...
                    <hr /> 
                      ...
                      <div class="col-md-12">
                              <div id="product_fields" class="my-4">
                                  <div class="mb-3 removeclass2">
                                      <form class="row">
                                          <div class="col-sm-3">
                                          ...
                                          <div class="col-sm-2">
                                              <div class="form-group">
                                                  <button class="btn btn-danger" type="button" onclick="remove_product_fields(2);">
                                  ...
                                  <div class="mb-3 removeclass3">
                                      <form class="row">
                                          ...
                                          <div class="col-sm-2">
                                              <div class="form-group">
                                                  <button class="btn btn-danger" type="button" onclick="remove_product_fields(3);">
                                                      <i class="ti ti-minus"></i>
                                                  </button>
                                              </div>
                                          </div>
                          ...
                          <form class="row">
                              ...
                              <div class="col-sm-2">
                                  <div class="mb-3">
                                      <button onclick="product_fields();" class="btn btn-success fw-medium" type="button">
